# 20260710 Agent Rule Contract v2 - skills-manager
...
## Verification
- `python D:\CODE\governed-ai-coding-runtime\scripts\verify-target-project-rules.py --targets skills-manager --require-all`
...
- 工作树边界：保留本轮前已有的 audit/MCP、imports、locks、tests 与其他证据改动；本任务回滚不得触碰它们。
