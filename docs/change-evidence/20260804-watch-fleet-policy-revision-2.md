...
- The final native metadata read shows exactly three unique task targets at a 10-minute cadence, all `PAUSED`, all `policy_revision=2`: target `019fcb85-7b8c-7740-abf7-08b821eb899a`, target `019fcbba-2a2a-7152-8089-414f0befef6e`, and dual-role supervisor `019fcbe5-8111-75d1-abed-c2be479097a6`. The supervisor envelope is `prompt_sha256=01d23f1f661e3743e81d678526d9194f9b74e40ef83da5529ef80d3c89d41989`; target envelopes are `prompt_sha256=426adb86cc5e1e900bb44fe5da3554570728e147d50ccdf5ec0e547eb37d7449`.
