...
- GitHub-hosted verification: [Agent Rule Contract](https://github.com/sciman-top/skills-manager/actions/runs/29110122279) completed successfully with checkout cleanup included.
