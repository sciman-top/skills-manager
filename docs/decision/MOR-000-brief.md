...
| 其他 preset baseline | `gpt56_terra_only` 与 `gpt56_luna_only` 均为 high/xhigh/max；Terra/Luna max 在 Codex config surface 的 exact fixture 通过前仅为用户选定候选，必须 `manual_mapping_required`，不得近似为 xhigh |
