...
- 当前 Lean Delivery maintenance：M0/M0.2/M0.3 11/11 历史 planning truth 保留；adjacent agent workflow advisory 5/5 `repo_verified/repo_advisory_only`，已实现 TaskGraph/Radar/FailurePacket、wave/admission/model/escalation 与 zero-write CLI，但不 spawn/call provider/fetch Radar/改 host。TC0/TC1 shadow PoC 3/3，PS7-only runtime 已收敛，TC2 `not_started`；M1 仍 `collecting (0/10)`，P6/host/live 不变。
