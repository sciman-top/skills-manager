...
5. When creating PPTX, use the built-in Presentations capability first and follow its supported `pptx` workflow. Use web slides only when animation or interactive simulation is central.
