...
<message>state=...;receipt_key=...;current_tick_id=...;previous_tick_id=...;snapshot_key=...;shutdown_receipt_key=...;schedule_authorization_receipt_key=...;shutdown_receipt_expires_at_utc=...;visibility_complete=true|false;list_limit_reached=true|false;visible_count=...;eligible_count=...;monitored_count=...;blocking_unmonitored_count=...;changed_count=...</message>
</heartbeat>
'@
